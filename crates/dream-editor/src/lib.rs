...
pub(crate) mod menu_bar_panel;
pub(crate) mod renderer_controls_panel;
pub(crate) mod renderer_panel;
pub(crate) mod scene_hierarchy_panel;
...
impl EditorEguiWgpu {
    pub async fn new(
        ...
        let scene_hierarchy_panel = Arc::new(Mutex::new(SceneHierarchyPanel::new(Arc::downgrade(
            &app.scene,
        ))));
        ...
        Self {
            ...
            panels: vec![
                ...
                Arc::new(Mutex::new(InspectorPanel::default())),
                assets_panel,
